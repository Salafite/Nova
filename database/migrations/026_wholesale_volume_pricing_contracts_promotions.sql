...
COMMENT ON COLUMN "Nova".t0120.discount_type IS 'Discount application type: FixedPrice | Percentage';
...
COMMENT ON COLUMN "Nova".t0121.priority IS 'Priority ranking when resolving overlapping rules (higher = priority)';
