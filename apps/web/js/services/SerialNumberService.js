window.SerialNumberService = class SerialNumberService {
  constructor() {
    this.api = new ApiClient('/api/T0087I')
    this._data = []
  }

  async load() {
    try { this._data = await this.api.list() || [] } catch (e) { console.warn('Failed to load serial numbers', e); this._data = [] }
  }
