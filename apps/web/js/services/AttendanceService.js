window.AttendanceService = class AttendanceService {
  constructor() {
    this.api = new ApiClient('T0036I')
    this._data = []
  }
  async load() {
    try { this._data = await this.api.list() || [] } catch (e) { console.warn('Failed to load attendance', e); this._data = [] }
  }
