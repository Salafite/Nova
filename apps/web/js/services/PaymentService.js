window.PaymentService = class PaymentService {
  constructor() {
    this.api = new ApiClient('T0091I')
    this._data = []
  }

  async load() {
    try { this._data = await this.api.list() || [] } catch (e) { console.warn('Failed to load payments', e); this._data = [] }
  }
