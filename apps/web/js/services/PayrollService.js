window.PayrollService = class PayrollService {
  constructor() {
    this.api = new ApiClient('T0039I')
    this._data = []
  }
  async load() {
    try { this._data = await this.api.list() || [] } catch (e) { console.warn('Failed to load payroll', e); this._data = [] }
  }
