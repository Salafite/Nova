window.BatchNumberService = class BatchNumberService {
  constructor() {
    this.api = new ApiClient('/api/T0088I')
    this._data = []
  }

  async load() {
    try { this._data = await this.api.list() || [] } catch (e) { console.warn('Failed to load batch numbers', e); this._data = [] }
  }
