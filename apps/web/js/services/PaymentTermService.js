window.PaymentTermService = class PaymentTermService {
  constructor() {
    this.api = new ApiClient('T0096I')
    this._data = []
  }

  async load() {
    try { this._data = await this.api.list() || [] } catch (e) { console.warn('Failed to load payment terms', e); this._data = [] }
  }
