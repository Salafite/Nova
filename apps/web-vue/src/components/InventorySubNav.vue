...
const tabs = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Replenishment', label_ar: 'إعادة التموين', icon: 'auto_mode', route: 'inventory-replenishment' },
      ...
      { label: 'Batch Recall Trace', label_ar: 'تتبع سحب الدفعات', icon: 'crisis_alert', route: 'batch-recall' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Stock Transfers', label_ar: 'تحويلات المخزون', icon: 'sync_alt', route: 'stock-transfers' },
