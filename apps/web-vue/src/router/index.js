...
const ROUTE_PERMISSIONS = {
  ...
  'warehouse-temperature-zones': 'warehouse',
  'temperature-zones': 'warehouse',
  'quality-haccp-audit': 'manufacturing',
  'haccp-audit': 'manufacturing',
  ...
  'sales-delivery-routes': 'sales',
  'sales-driver-manifest': 'sales',
  'sales-returns': 'sales',
  ...
  'edi-gateway': 'integrations',
  'edi-partners': 'integrations',
  'edi-sku-mapping': 'integrations',
  'edi-transactions': 'integrations',
  'edi-pallet-sscc': 'integrations',
...
const routes = [
  ...
  { path: '/terms', name: 'terms', component: () => import('../views/legal/TermsView.vue') },
  {
    ...
    children: [
      ...
      { path: 'sales/delivery-routes', name: 'sales-delivery-routes', meta: { requiresAuth: true }, component: () => import('../views/sales/DeliveryRoutePlanningView.vue') },
      { path: 'sales/driver-manifest/:id', name: 'sales-driver-manifest', meta: { requiresAuth: true }, component: () => import('../views/sales/DriverManifestView.vue') },
      ...
      { path: 'inventory/replenishment', name: 'inventory-replenishment', meta: { requiresAuth: true }, component: () => import('../views/inventory/ReplenishmentSuggestionsView.vue') },
      { path: 'replenishment', redirect: { name: 'inventory-replenishment' } },
      ...
      { path: 'accounting/einvoicing', name: 'einvoicing', meta: { requiresAuth: true }, component: () => import('../views/accounting/EInvoicingView.vue') },
      { path: 'einvoicing', redirect: { name: 'einvoicing' } },
      { path: 'accounting/fiscal-settings', name: 'fiscal-settings', meta: { requiresAuth: true }, component: () => import('../views/accounting/FiscalSettingsView.vue') },
      { path: 'fiscal-settings', redirect: { name: 'fiscal-settings' } },
      ...
      { path: 'inventory/batch-recall', name: 'batch-recall', meta: { requiresAuth: true }, component: () => import('../views/inventory/BatchRecallView.vue') },
      ...
      { path: 'ar-reminders', name: 'ar-reminders', meta: { requiresAuth: true }, component: () => import('../views/accounting/ARRemindersView.vue') },
      { path: 'accounting/reminders', redirect: { name: 'ar-reminders' } },
      ...
      { path: 'warehouse/transfers', name: 'stock-transfers', meta: { requiresAuth: true }, component: () => import('../views/warehouse/StockTransfersView.vue') },
      { path: 'warehouse/transfers/:id', name: 'stock-transfer-detail', meta: { requiresAuth: true }, component: () => import('../views/warehouse/StockTransferDetailView.vue') },
      { path: 'warehouse/temperature-zones', name: 'warehouse-temperature-zones', meta: { requiresAuth: true }, component: () => import('../views/warehouse/TemperatureZonesView.vue') },
      { path: 'quality/haccp-audit', name: 'quality-haccp-audit', meta: { requiresAuth: true }, component: () => import('../views/quality/HaccpAuditView.vue') },
      { path: 'haccp-audit', redirect: { name: 'quality-haccp-audit' } },
      { path: 'stock-transfers', redirect: { name: 'stock-transfers' } },
      ...
      { path: 'bi/executive', name: 'bi-executive', meta: { requiresAuth: true }, component: () => import('../views/bi/ExecutiveAnalyticsView.vue') },
      ...
      { path: 'integrations/edi-gateway', name: 'edi-gateway', meta: { requiresAuth: true }, component: () => import('../views/integrations/EdiGatewayView.vue') },
      { path: 'integrations/edi-partners', name: 'edi-partners', meta: { requiresAuth: true }, component: () => import('../views/integrations/EdiPartnersView.vue') },
      { path: 'integrations/edi-sku-mapping', name: 'edi-sku-mapping', meta: { requiresAuth: true }, component: () => import('../views/integrations/EdiSkuMappingView.vue') },
      { path: 'integrations/edi-transactions', name: 'edi-transactions', meta: { requiresAuth: true }, component: () => import('../views/integrations/EdiTransactionsView.vue') },
      { path: 'integrations/edi-pallet-sscc', name: 'edi-pallet-sscc', meta: { requiresAuth: true }, component: () => import('../views/integrations/EdiPalletSsccView.vue') },
