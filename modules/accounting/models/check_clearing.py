...
class BankStatementCreate(BaseModel):
    ...
    file_type: str = Field('OFX', max_length=20)
    status: str = Field('Uploaded', max_length=30)
...
class StatementTransactionCreate(BaseModel):
    ...
    amount: float
    transaction_type: str = Field('CHECK', max_length=50)
    match_status: str = Field('Pending', max_length=30)
...
BANK_STATEMENT_REPO = CrudRepository(
    ...
    business_columns=[
        ...
        'total_deposits', 'total_withdrawals', 'file_name', 'file_type',
...
STATEMENT_TRANSACTION_REPO = CrudRepository(
    ...
    business_columns=[
        ...
        'matched_payment_id', 'match_score', 'notes', 'is_active'
    ]
)
...
CHECK_CLEARING_RECORD_REPO = CrudRepository(
    ...
    business_columns=[
        ...
        'issue_date', 'clearing_date', 'status', 'bounced_date', 'bounced_reason',
        'penalty_fee', 'credit_hold_triggered', 'notes', 'is_active'
    ]
)
