...
repo = CrudRepository('T0005', business_columns=['id', 'attribute_name', 'attribute_type', 'display_type', 'description', 'is_required', 'create_variant', 'attribute_group', 'sort_order', 'is_active'])
