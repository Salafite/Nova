...
class WeeklyDemandProjection(BaseModel):
...
class SKUForecastParameters(BaseModel):
    ...
    weekly_projections: List[WeeklyDemandProjection] = Field(default_factory=list, description="Future weekly demand projections")
